...
$query = $connection->prepare("SELECT * FROM categories ORDER BY category_id ASC");
$query->execute();

// Je stocke chaque données récupérés par la requête dans une variable nommée "category"
